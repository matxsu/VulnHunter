...
- **Security Modules**: Specialized detectors for SQL Injection, XSS, CSRF, SSRF, and Path Traversal.
- **Cyber-Style Dashboard**: A premium, real-time terminal-style GUI for monitoring scans.
